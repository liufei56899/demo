 ...
 * @version 2016-05-23
 */
public class XsJbxx extends DataEntity<XsJbxx> {
	...
	private String lzhzxxmc;	//联招合作学校名称
	private String sfxwjxdxs;	//是否校外教学点学生

	private String zssyd;		//招生生源地
	private String photo;//上传图片
	private MultipartFile  file;//临时保存用
	private BjJbxx newBjmc; 	//调整后班级名称
	private ZyJbxx newZyid;		//调整后专业
	private String bgydlxzt;	//变更异动类型状态
	private String bgydlx;		//变更异动类型
	private String bgydlxlszt;  //变更异动类型临时状态
	private String isXsFenBan;//是否分班
	...
	public String getIsXsFenBan() {
		return isXsFenBan;
	}

	public void setIsXsFenBan(String isXsFenBan) {
		this.isXsFenBan = isXsFenBan;
	}

	public String getBgydlxlszt() {
		return bgydlxlszt;
	}

	public void setBgydlxlszt(String bgydlxlszt) {
		this.bgydlxlszt = bgydlxlszt;
	}

	public BjJbxx getNewBjmc() {
		return newBjmc;
	}

	public void setNewBjmc(BjJbxx newBjmc) {
		this.newBjmc = newBjmc;
	}

	public ZyJbxx getNewZyid() {
		return newZyid;
	}

	public void setNewZyid(ZyJbxx newZyid) {
		this.newZyid = newZyid;
	}


	
	public String getBgydlxzt() {
		return bgydlxzt;
	}

	public void setBgydlxzt(String bgydlxzt) {
		this.bgydlxzt = bgydlxzt;
	}

	public String getBgydlx() {
		return bgydlx;
	}

	public void setBgydlx(String bgydlx) {
		this.bgydlx = bgydlx;
	}
	...
	public String getZssyd() {
		return zssyd;
	}

	public void setZssyd(String zssyd) {
		this.zssyd = zssyd;
	}

	@Length(min = 0, max = 1, message = "是否校外教学点学生长度必须介于 0 和 1 之间")
	@ExcelField(title = "是否校外教学点学生", align = 2, sort = 170, groups = { 2 }, dictType = "sfdm")
	public String getSfxwjxdxs() {
		return sfxwjxdxs;
	}

	public void setSfxwjxdxs(String sfxwjxdxs) {
		this.sfxwjxdxs = sfxwjxdxs;
	}
	...
	public String getLzhzxxmc() {
		return lzhzxxmc;
	}

	public void setLzhzxxmc(String lzhzxxmc) {
		this.lzhzxxmc = lzhzxxmc;
	}
