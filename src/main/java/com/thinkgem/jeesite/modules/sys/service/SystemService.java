...
public class SystemService extends BaseService implements InitializingBean {
	...
	public void updateIsKjMenu(Map<String,Object> map)
	{
		menuDao.updateIsKjMenu(map);
	}
	
	@Transactional(readOnly = false)
	public void deleteKjMenu(Map<String,Object> map)
	{
		menuDao.deleteKjMenu(map);
	}
	
	public List<Menu> findMenuAllList(Menu menu)
	{
		
		return menuDao.findMenuAllList(menu);
	}
	...
	public User getNewLoginName(User user){
		user = userDao.getNewLoginName(user);
		return user;
	}
	...
	public List<User> findSysUserByOfficeId(String officeId) {
		List<User> list = userDao.findSysUserByOfficeId(officeId);
		return list;
	}
...
//		systemRealm.clearAllCachedAuthorizationInfo();
	...
	public List<User> findUserByJdId(User user){
		return userDao.findUserByJdId(user);
	}
	/**
	 * 查询所有教师
	 * @return
