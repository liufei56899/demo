...
public class RoleController extends BaseController {
	 ...
	 */
	/*@RequiresPermissions("sys:role:view")*/
	@RequestMapping(value = "menuWeiHu")
	public String menuWeiHu(Model model) {
		model.addAttribute("menuList", systemService.findAllMenu());
		/*boolean istrue = true;
		...
		if(istrue)
		{
			model.addAttribute("menuList", systemService.getMenuListAll());
		}else
		{
			model.addAttribute("menuList", systemService.findKuaiJieMenu());
		}*/
		/*model.addAttribute("menuList", systemService.findKuaiJieMenu());*/
		/*model.addAttribute("menuList", systemService.findAllMenu());*/
		
		return "modules/school/menuWeihu";
	}
	 ...
	 * String
	 */
	@RequestMapping(value = "zxbzpage")
	public String zxbzpage()
	{
		return "modules/zxbz/help";
	}

	/***
	 * 
	 * Des:是否有子节点 2016-7-26
	 * 
	 * @author fn
	 * @param menu
	 * @return String
	 */
	@ResponseBody
	@RequestMapping(value = "findMenuByParentId")
	public String findMenuByParentId(Menu menu) {
		List<Menu> jsList = systemService.findByParentId(menu);
		Map map = new HashMap();
	...
	public String saveMenu(@RequestParam("menuIds") String menuIds,
		...
		if (menuIdList != null && menuIdList.size() > 0) {
			...
			map.put("iskjmenu", "1");
			this.systemService.updateIsKjMenu(map);
		}
	...
	public List<Role> getRoleByUserId(String id) {
		List<Role> r = systemService.getRoleByUserId(id);
		return r;
	}
