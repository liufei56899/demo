...
public class Page<T> {
	...
	public String toString() {
		...
		/*sb.append("跳转&nbsp;&nbsp;<input type=\"text\" value=\""+pageNo+"\" onkeypress=\"var e=window.event||this;var c=e.keyCode||e.which;if(c==13)");
		sb.append(funcName+"(this.value,"+pageSize+",'"+funcParam+"');\" onclick=\"this.select();\"/>&nbsp;&nbsp;页&nbsp;&nbsp;");*/
		
		sb.append("跳转&nbsp;&nbsp;<input type=\"text\" id=\"yema\" value=\""+pageNo+"\"/>&nbsp;&nbsp;页&nbsp;&nbsp;");
		
		sb.append("<input type=\"button\" value=\"Go\" onclick=\"javascript:page(document.getElementById('yema').value,"+pageSize+",'')\"/>&nbsp;&nbsp;");
		...
		sb.append("<select name=\"\" id=\"\" onchange=\"javascript:page("+pageNo+",this.value,'')\">");
...
//		sb.insert(0,"<div class=\"page\">\n").append("</div>\n");
		...
		sb.append("$(\"#Pagination\").pagination(\"15\");");
		sb.append("});");
		sb.append("</script>");
		...
		sb.append("<div class=\"searchPage\">");
		sb.append("<span class=\"page-sum\">共<strong class=\"allPage\">15</strong>页</span>");
		sb.append("<span class=\"page-go\">跳转<input type=\"text\">页</span>");
		sb.append("<a href=\"javascript:;\" class=\"page-btn\">GO</a>");
		sb.append("</div>");
