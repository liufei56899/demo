...
<script src="${ctxStatic}/validMes/validMes.js" type="text/javascript" ></script>
<script src="${ctxStatic}/Highcharts/highcharts.js" type="text/javascript" ></script>
<link href="${ctxStatic}/lg/lg.css" type="text/css" rel="stylesheet" />
<link rel="stylesheet" type="text/css" href="${ctxStatic}/multiple-select-master/multiple-select.css" />
<script type="text/javascript" src="${ctxStatic}/multiple-select-master/multiple-select.js"></script>
