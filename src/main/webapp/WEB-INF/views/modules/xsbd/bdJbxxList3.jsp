...
<body onload="StartVideo();StartVideo2();"
	...
	<div class="content-box">
		...
		<!-- -------------------------------------身份证读卡器识别数据-------------------------------- -->
		<div class="o-information " style="height: 350px">
	...
	<span class="help-inline"><font color="red">*</font> </span>
			...
			<div class="r-group">
		     			<label class="gr-mc">班级名称：</label>
						<div class="controls">
	<form:input path="bj" htmlEscape="false" maxlength="32" 
	class="input-xlarge requ " style="width:200px;"/>
...
<%-- 					 <div class="r-group">
					<label class="gr-mc"></label>
			<div  class="mc-input"> 
		<form:select path="jd" class="input-xlarge  required" style="width:215px;" id="xz2">
						<form:option value="" label="请选择乡"/>
					</form:select>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
	...
	<form:input path="lxdh" htmlEscape="false" maxlength="32" style="width:200px;"
		 ...
		 <div class="r-group">
		   ...
		   <div class="r-group">
		     			<label class="gr-mc">准考证号：</label>
						<div class="controls">
	<form:input path="zkzh" htmlEscape="false" maxlength="32" style="width:205px;"
	class="input-xlarge  required"/>
	<span class="help-inline"><font color="red">*</font> </span>
			</div>
		   </div>
	...
	<form:input path="lxdh" htmlEscape="false" maxlength="32" style="width:215px;"
		   ...
		   <div class="r-group">
		     			<label class="gr-mc">准考证号：</label>
						<div class="controls">
	<form:input path="zkzh" htmlEscape="false" maxlength="32" style="width:215px;"
	class="input-xlarge  required"/>
	<span class="help-inline"><font color="red">*</font> </span>
			</div>
		   </div>
