...
<script type="text/javascript">
	...
	function fillForm(ret) {
		...
		var sexHtml = "<select id='xbm2' name='xbm' style='width:100%;'>";
		if (pSex == "1" || pSex == 1) {
		...
		if (initocr != 0) {
		   ...
		   // alert(time+"      ........");
			...
			if (ocrresult.length < 1) {
				...
				$("#cxm").val(str[0]);
				var xb = str[1];
				var sexHtml = "<select id='xbm1' name='xbm' style='width:100%;'>";
				if (xb == "男") {
					sexHtml += "<option value='1' selected='selected'>男</option>";
					sexHtml += "<option value='2' >女</option>";
				} else {
				...
				$("#qxm").val(str[0]);
				var xb = str[1];
				var sexHtml = "<select id='xbmc' name='xbm' style='width:100%;'>";
				if (xb == "男") {
					sexHtml += "<option value='1' selected='selected'>男</option>";
					sexHtml += "<option value='2' >女</option>";
				} else {
...
<script type="text/javascript">
	function loadXSDJXX(personID) {
		$.post("${ctx}/zsdj/zsdj/getZsdjBySfzh", {
			...
			$("#djqy").val(data.zsdj.sfName+data.zsdj.csName+data.zsdj.qxName+data.zsdj.jdName);
			$("#syx").val(data.zsdj.fromSchool);
		...
		if(index==0){
		 ...
		 var title = document.getElementById("zyid");
		  for ( var i = 0; i < title.options.length; i++) {
			if (title.options[i].value == data.zsdj.zy.id) {
...
<body onload="StartVideo();StartVideo2();"
	...
	<div class="content-box">
		<div class="f-information">
			<div class="left-information" style="width:49.8%; float:left;">
			<!-- -------------------------------------------新生登记信息查询------------------------------------------------- -->
				<div class="cxtj">查询条件</div>
				<div class="ul-form">
					<div class="cxtj-input">
					    <label> 姓名:</label>
							<input id="zsdj_xm" maxlength="64" class="input-medium" type="text" />
						
						<label>性别:</label>	
							<select id="zsdj_xbm" class="input-medium">
					...
					<div class="cxtj-btn">
							...
							<input id="btnSerach" disabled="true" class="btn btn-primary"  type="button" onclick="serachZsdj();" value="查询" />
							<input id="btnReset" class="btn btn-primary" type="reset" onclick="resetClick();"  value="重置" />
						
					</div>
				</div>
			<!-- -------------------------------------------查询列表显示------------------------------------------------- -->
				<div id="serachList" style="display: none" class="cxjg-box">
			...
			<!-- -------------------------------------------新生登记信息------------------------------------------------- -->
				<h1 class="title" style="margin-bottom: 15px;">新生登记信息</h1>
				...
				<div class="group">
					<label class="gr-mc">身份证件号码：</label> <input class="gr-input" type="text" id="ID1"
						readonly="readonly">
				</div>
				<div class="group">
				...
				<div class="group">
					<label class="gr-mc">生源地区：</label> <input class="gr-input" type="text" id="djqy"
						readonly="readonly">
				</div>
				<div class="group">
					<label class="gr-mc">生源校：</label> <input class="gr-input" type="text" id="syx"
						readonly="readonly">
				</div>
		...
		<!-- -------------------------------------身份证读卡器识别数据-------------------------------- -->
		<div class="o-information " style="height: 900px; border-bottom: none;">
			<div class="right-information photo" style="width:49.8%; float:left;">
				...
				<form:form id="inputForm1" modelAttribute="bdJbxx"
					...
					<div class="r-group">
						...
						<div class="group" id="rxbmP">
							<form:select path="xbm" id="xbm" class="input-xlarge required gr-r-mc" style="width:100%;" >
					...
					<div class="r-group">
						...
						<div class="group">
							<form:select path="sfzjlx" class="input-xlarge  required" style="width:100%;" id="sfzID" >
								<form:option value="" label="" />
		  ...
		  <div class="right-group">
			<label class="gr-mc">生源地区：</label>
			<div  class="mc-input">
			<form:select path="sf" id="sf1" class="input-xlarge  required" style="width:20%;" onchange="byCS1(this.value)" >
						<form:option value="" label="请选择省"/>
						<form:options items="${fns:findBySF()}" itemLabel="name" itemValue="id" htmlEscape="false"/>
					</form:select>
			<form:select path="cs" class="input-xlarge  required"  style="width:20%;" id="cs1" onchange="byQX1(this.value)" >
						<form:option value="" label="请选择市"/>
					</form:select>
			<form:select path="qx" class="input-xlarge  required"  style="width:20%;" id="qx1"  onchange="byXZ1(this.value)" >
		...
		<form:select path="jd" class="input-xlarge  required"   style="width:61%;"  id="jd1">
			...
			<div class="mc-input">
				<form:input path="fromSchool" htmlEscape="false" maxlength="32" id="fromSchool1"
					        class="input-xlarge required" style="width:260px;"/>
			    <span class="help-inline"><font color="red">*</font> </span>
			</div>
			</div>
					...
					<div class="right-group">
						...
						<div class="mc-input" id="zyByLx1">
							<select name="zylxId" class="input-medium requ" id="zyid">
			...
			<!-- ------------------------------------身份证/复印件扫描---------------------------------- -->
			<div class="clearfix"></div>
			<div class="right-information photo" style=" display:none; width:49.8%; float:left;">
				...
				<form:form id="inputForm2" modelAttribute="bdJbxx"
					...
					<div class="r-group">
						...
						<div class="group" id="cxb">
							<form:select path="xbm" class="input-xlarge required gr-r-mc" style="width:100%;" >
								<form:option value="" label="" />
								<form:options items="${fns:getDictList('sex')}"
									itemLabel="label" itemValue="value" htmlEscape="false" />
							</form:select>
					...
					<div class="r-group">
						...
						<div class="group">
							<form:select path="sfzjlx" class="input-xlarge required gr-r-mc" style="width:100%;" 
								id="csfzjlx">
								<form:option value="" label="" />
								<form:options items="${fns:getDictList('sfzjlx')}"
									itemLabel="label" itemValue="value" htmlEscape="false" />
			...
			<label class="gr-mc">生源地区：</label>
			<div  class="mc-input">
			<form:select path="sf"  id="sf2" class="input-xlarge  required" style="width:20%;" onchange="byCS2(this.value)" >
						<form:option value="" label="请选择省"/>
						<form:options items="${fns:findBySF()}" itemLabel="name" itemValue="id" htmlEscape="false"/>
					</form:select>
			<form:select path="cs" class="input-xlarge  required" style="width:20%;" id="cs2" onchange="byQX2(this.value)" >
						<form:option value="" label="请选择市"/>
					</form:select>
			<form:select path="qx" class="input-xlarge  required" style="width:20%;" id="qx2"  onchange="byXZ2(this.value)" >
						<form:option value="" label="请选择县"/>
					</form:select>
					</div>
					</div>
					...
					<label class="gr-mc"></label>
			<div  class="mc-input"> 
		<form:select path="jd" class="input-xlarge  required" style="width:61%;" id="xz2">
						<form:option value="" label="请选择乡"/>
					</form:select>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
			...
			<!-- --------------------------------------户口簿/复印件扫描------------------------------------------------ -->
			<div class="right-information photo" style="height:980px; display:none; width:49.8%; float:left;">
				...
				<form:form id="inputForm3" modelAttribute="bdJbxx"
					...
					<div class="r-group">
						...
						<div class="group">
							<form:input path="cname" htmlEscape="false" maxlength="64" style="width:100px"
			...
			<label class="gr-mc">生源地区：</label>
			<div  class="mc-input">
			<form:select path="sf"  id="sf3" class="input-xlarge  required" style="width:20%;" onchange="byCS3(this.value)" >
						<form:option value="" label="请选择省"/>
						<form:options items="${fns:findBySF()}" itemLabel="name" itemValue="id" htmlEscape="false"/>
					</form:select>
			<form:select path="cs" class="input-xlarge  required" style="width:20%;" id="cs3" onchange="byQX3(this.value)" >
						<form:option value="" label="请选择市"/>
					</form:select>
			<form:select path="qx" class="input-xlarge  required" style="width:20%;" id="qx3"  onchange="byXZ3(this.value)" >
						<form:option value="" label="请选择县"/>
					</form:select>
					</div>
					</div>
					...
					<label class="gr-mc"></label>
			<div  class="mc-input"> 
		<form:select path="jd" class="input-xlarge  required" style="width:61%;" id="xz3">
						<form:option value="" label="请选择乡"/>
					</form:select>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
			...
			<div class="mc-input">
			    ...
			    <span class="help-inline"><font color="red">*</font> </span>
					...
					<div class="right-group">
						<label class="gr-mc">身份证件类型：</label>
						<div class="mc-input">
							<form:select path="sfzjlx" class="input-xlarge required requ" style="width:100%;" 
								id="ccsfzjlx">
								<form:option value="" label="" />
								<form:options items="${fns:getDictList('sfzjlx')}"
									itemLabel="label" itemValue="value" htmlEscape="false" />
					   ...
					   <label class="gr-mc">专业名称：</label>
						<div class="mc-input" id="zyByLx3">
							...
							<div class="mc-input" id="zyinfo2">
							    <form:input path="xz" class="input-xlarge requ"  id="xzc" type="text" readonly="true"/>
						    </div>
						</div>
				</form:form>
			</div>
				...
				<form:form id="inputForm4" modelAttribute="bdJbxx"
					...
					<div class="r-group">
						...
						<div class="group" id="qxbm">
							<form:select path="xbm" class="input-xlarge required gr-r-mc" style="width:100%;"  id="cc">
								<form:option value="" label="" />
								<form:options items="${fns:getDictList('sex')}"
									itemLabel="label" itemValue="value" htmlEscape="false" />
							</form:select>
			...
			<label class="gr-mc">生源地区：</label>
			<div  class="mc-input">
			<form:select path="sf" id="sf4" class="input-xlarge  required" style="width:20%;" onchange="byCS4(this.value)" >
						<form:option value="" label="请选择省"/>
						<form:options items="${fns:findBySF()}" itemLabel="name" itemValue="id" htmlEscape="false"/>
					</form:select>
			<form:select path="cs" class="input-xlarge  required" style="width:20%;" id="cs4" onchange="byQX4(this.value)" >
						<form:option value="" label="请选择市"/>
					</form:select>
					<form:select path="qx" class="input-xlarge  required" style="width:20%;" id="qx4"  onchange="byXZ4(this.value)" >
						<form:option value="" label="请选择县"/>
					</form:select>
					</div>
					</div>
		...
		<form:select path="jd" class="input-xlarge  required" style="width:61%;" id="xz4">
						<form:option value="" label="请选择乡"/>
					</form:select>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
			...
			<div class="mc-input">
			    ...
			    <span class="help-inline"><font color="red">*</font> </span>
					...
					<!-- <div class="right-group">
						    ...
						    <label class="gr-mc">学制：</label>
							<div class="mc-input" id="zyinfo3">
							    <form:input path="xz" class="input-xlarge requ"  id="xzd" type="text" readonly="true"/>
						    </div>
						</div>
				</form:form>
			</div>
