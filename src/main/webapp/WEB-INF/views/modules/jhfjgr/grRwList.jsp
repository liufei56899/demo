...
<body>
	...
	<form:form id="searchForm" modelAttribute="jhFjGr" action="${ctx}/jhfjgr/jhFjGr/rwList/" method="post" class="breadcrumb form-search">
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		<thead>
			<tr>
				...
				<th>招生完成数</th>
				<th>更新时间</th>
				<shiro:hasPermission name="jhfjgr:jhFjGr:edit"><th>招生区域</th></shiro:hasPermission>
			</tr>
		</thead>
		<tbody>
		<c:forEach items="${page.list}" var="jhFjGr">
			<tr>
				...
				<shiro:hasPermission name="jhfjgr:jhFjGr:edit"><td>
    				<a href="javascript:searchGrrw('${jhFjGr.id}');">查看招生区域</a>
