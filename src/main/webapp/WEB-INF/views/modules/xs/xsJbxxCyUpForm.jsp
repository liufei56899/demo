	...
	<form:form id="inputForm1" modelAttribute="xsJbxx" action="${ctx}/xs/xsJbxx/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			<div class="lg-form">
				...
				<div class="controls">
					<form:input path="cyyxm" id="cyyxm" htmlEscape="false" maxlength="15" class="input-xlarge" onchange="chengYuanYiOnBlur();" style="width:220px;"/>
			...
			<div class="lg-form">
				...
				<div class="controls">
					<form:select path="cyygx" id="cyygx" class="input-xlarge " style="width:234px;">
		...
		<div class="control-group">
			<div class="lg-form">
				...
				<div class="controls">
					<form:select path="cyysfjhr" id="cyysfjhr" class="input-xlarge " style="width:234px;">
						<form:option value="" label=""/>
			...
			<div class="lg-form">
				...
				<div class="controls">
					<form:input path="cyylxdh" id="cyylxdh" htmlEscape="false" maxlength="32" class="input-xlarge " style="width:220px;"/>
					<span class="help-inline"></span>
				</div>
			</div>
		</div>
			...
			<div class="lg-form">
				...
				<div class="controls">
					<input name="cyycsny" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate "
						...
						onclick="WdatePicker({dateFmt:'yyyy-MM-dd',isShowClear:false});" style="width:220px;"/>
				</div>
			</div>
			<div class="lg-form">
				<label class="control-label">身份证件类型：</label>
				<div class="controls">
					<form:select path="cyysfzjlx" class="input-xlarge " style="width:234px;">
						<form:option value="" label=""/>
			...
			<div class="lg-form">
				...
				<div class="controls">
					<form:input path="cyysfzjh" id="cyysfzjh" onblur="validateSfz1();"
						htmlEscape="false" maxlength="18" class="input-xlarge " style="width:220px;"/>
						<span class="help-inline"></span>
				</div>
			</div>
			<div class="lg-form">
				...
				<div class="controls">
					<form:select path="cyymzm" class="input-xlarge " style="width:234px;">
						<form:option value="" label=""/>
		...
		<div class="control-group">
			<div class="lg-form">
				...
				<div class="controls">
					<form:select path="cyyzzmmm" class="input-xlarge " style="width:234px;">
						<form:option value="" label=""/>
			...
			<div class="lg-form">
				...
				<div class="controls">
					<form:select path="cyyjkzkm" class="input-xlarge " style="width:234px;">
						<form:option value="" label=""/>
		...
		<div class="control-group">
			<div class="lg-form">
				...
				<div class="controls">
					<form:input path="cyygzhxxdw" htmlEscape="false" maxlength="255" class="input-xlarge " style="width:220px;"/>
				</div>
			</div>
			<div class="lg-form">
				<label class="control-label">职务：</label>
				<div class="controls">
					<form:input path="cyyzw" htmlEscape="false" maxlength="20" class="input-xlarge " style="width:220px;"/>
				</div>
			</div>
		</div>
		<fieldset>
		...
		<div class="control-group">
			<div class="lg-form">
				<label class="control-label">姓名：</label>
				<div class="controls">
					<form:input path="cyexm" id="cyexm" htmlEscape="false" maxlength="15" class="input-xlarge " style="width:220px;" onchange="chengYuanErOnBlur()"/>
					<span class="help-inline"></span>
				</div>
			</div>
			<div class="lg-form">
				<label class="control-label">关系：</label>
				<div class="controls">
					<form:select path="cyegx" id="cyegx" class="input-xlarge " style="width:234px;">
						<form:option value="" label=""/>
						<form:options items="${fns:getDictList('cygx')}" itemLabel="label" itemValue="value" htmlEscape="false"/>
					</form:select>
					<span class="help-inline"></span>
		...
		<div class="control-group">
			<div class="lg-form">
				<label class="control-label">是否监护人：</label>
				<div class="controls">
					<form:select path="cyesfjhr" id="cyesfjhr" class="input-xlarge " style="width:234px;">
						<form:option value="" label=""/>
						<form:options items="${fns:getDictList('sfdm')}" itemLabel="label" itemValue="value" htmlEscape="false"/>
					</form:select>
					<span class="help-inline"></span>
			...
			<div class="lg-form">
				<label class="control-label">联系电话：</label>
				<div class="controls">
					<form:input path="cyelxdh" id="cyelxdh" htmlEscape="false" maxlength="32" class="input-xlarge " style="width:220px;"/>
					<span class="help-inline"></span>
				</div>
			</div>
		</div>
		<div class="control-group">
			...
			<div class="lg-form">
				<label class="control-label">身份证件类型：</label>
				<div class="controls">
					<form:select path="cyesfzjlx" class="input-xlarge " style="width:234px;">
						<form:option value="" label=""/>
						<form:options items="${fns:getDictList('sfzjlx')}" itemLabel="label" itemValue="value" htmlEscape="false"/>
					</form:select>
				</div>
		...
		<div class="control-group">
			...
			<div class="lg-form">
				<label class="control-label">民族：</label>
				<div class="controls">
					<form:select path="cyemzm" class="input-xlarge " style="width:234px;">
						<form:option value="" label=""/>
						<form:options items="${fns:getDictList('nation')}" itemLabel="label" itemValue="value" htmlEscape="false"/>
					</form:select>
				</div>
		...
		<div class="control-group">
			<div class="lg-form">
				<label class="control-label">政治面貌：</label>
				<div class="controls">
					<form:select path="cyezzmmm" class="input-xlarge " style="width:234px;">
						<form:option value="" label=""/>
						<form:options items="${fns:getDictList('zzmm')}" itemLabel="label" itemValue="value" htmlEscape="false"/>
					</form:select>
				</div>
			...
			<div class="lg-form">
				<label class="control-label">健康状况：</label>
				<div class="controls">
					<form:select path="cyejkzkm" class="input-xlarge " style="width:234px;">
						<form:option value="" label=""/>
						<form:options items="${fns:getDictList('health')}" itemLabel="label" itemValue="value" htmlEscape="false"/>
					</form:select>
				</div>
		...
		<div class="control-group">
			<div class="lg-form">
				<label class="control-label">工作或学习单位：</label>
				<div class="controls">
					<form:input path="cyegzhxxdw" htmlEscape="false" maxlength="255" class="input-xlarge " style="width:220px;"/>
				</div>
			</div>
			<div class="lg-form">
				<label class="control-label">职务：</label>
				<div class="controls">
					<form:input path="cyezw" htmlEscape="false" maxlength="20" class="input-xlarge " style="width:220px;"/>
				</div>
			</div>
		</div>
