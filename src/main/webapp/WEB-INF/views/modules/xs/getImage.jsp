		...
		<div class="o-photo_body photo-body">
			<div class="photo-frame">
				...
				<SPAN STYLE='color: red'>ActiveX 控件装入失败! -- 请检查浏览器的安全设置。CamSDKOCX</SPAN>
							...
							<br>
					<span>姓名：${xsJbxx.xm }</span>
 					<span>身份证号码：${xsJbxx.sfzjh }</span>
 					<input type="hidden" id="number" value="${xsJbxx.sfzjh }"/>
				</div>
				<div class="photo">			
					<span class="pic">
					...
					<label>请选择拍摄类型：</label>
					<select onchange="getTYPE(this.value)" id="sel" name="sel">
 						...
 						<!-- <input type = "button" value = "学籍照片"  onClick = "SubTest();" name = "SubTest" >
						<input type = "button" value = "普通照片" onClick = "qiehuan1();" name = "qiehuan1" > -->
