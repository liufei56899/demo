...
<head>
	...
	<script type="text/javascript">
		...
		function SearchBmtj(){
		   $.getJSON("${ctx}/xs/xsJbxx/zstjgbmDb",function(data){
	           viewZstjbmDbInfo(data);//招生统计/各部门 对比
	       });
		}
...
<body>
	...
	<form:form id="searchForm1" modelAttribute="zsdj" action="${ctx}/xs/xsJbxx/bmtjForm/" method="post" class="breadcrumb form-search">
	<div class="cxtj">统计条件</div>
		...
		<tr>
			<td class="btns" colspan="4" align="center"><input id="btnSearch" onclick="SearchBmtj();" class="btn btn-primary" type="button" value="查询"/>
			</td>
		</tr>
		</table>
	</form:form>
