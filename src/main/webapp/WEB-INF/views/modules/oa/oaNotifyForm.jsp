...
<body>
	...
	<form:form id="inputForm" modelAttribute="oaNotify" action="${ctx}/oa/oaNotify/save" method="post" 
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:select path="type" class="input-xlarge required" style="width:215px;">
		...
		<div class="form-actions">
			<c:if test="${oaNotify.status ne '1'}">
				<input id="btnSubmit" class="btn btn-primary" type="submit" style="margin-left: 170px;" value="保 存"/>&nbsp;
			</c:if>
