...
<script type="text/javascript">
	...
	<form:form id="inputForm" modelAttribute="jhFj" action="${ctx}/jhfj/jhFj/save" method="post" class="form-horizontal">
		...
		<c:if test="${jhFj.grShZt ne '1' && jhFj.grShZt ne '2' }">
				<div class="control-group">
		        <label class="control-label">审核结果：</label>
				<div class="controls">
					 <form:radiobutton path="grShZt" name="grShZt" value="1" checked="true"/>通过  
                     <form:radiobutton path="grShZt" name="grShZt" value="2"/>不通过
		        </div>
			</div>
			<div class="control-group">
				<label class="control-label">审核意见：</label>
				<div class="controls">
					<form:textarea path="grSpnr" id = "grSpnr" htmlEscape="false" rows="4" maxlength="255" 
						class="input-xxlarge " style="width:598px;"/>
				</div>
			</div>
		...
		<div class="form-actions">
			<input id="btnSubmitOk" class="btn btn-primary" type="button" onclick="return saveBmSh();" value="确定"/>&nbsp;
