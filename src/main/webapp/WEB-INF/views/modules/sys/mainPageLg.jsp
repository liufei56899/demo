...
<html>
<head>
<title>欢迎登陆西安音乐学院附属中等音乐学校智慧校园管理系统</title>
...
<script type="text/javascript">
	...
	$(document).ready(function() {
	  ...
	  //-------------------------------------------------------------------------------------------------
			...
			if(data.list!=null)
			{
				...
				for(var i=0;i<length;i++){
					if(i<6)
					{
		               ...
		               content +=  "<p>"+"<span><a href='javascript:readNotify(\""+id+"\");'>"+title+"</a></span>"+"<span style=\"float:right;\" >"+updateDate+"</span>"+"</p>";
					}
				}
		...
		//个人招生统计信息
		$.getJSON("${ctx}/xs/xsJbxx/zstjGrList", function(data) {
    ...
    //打开待办事项
    function openDbsx(){
        openDialog("${ctx}/zsjh/zsjh/zsjh_dbsh","待办事项",1080,540);//zsjhDbsxTab
    }
</script>
</head>
<body>
	<div id="main">
	<img alt="欢迎" src="${ctxStatic}/images/index.jpg" style='width:100%; height:100%;'>	
		...
		<div class="title">
         ...
         <div class="grzs_div" style="height: 245px;">
			<div id="content_top_grzstj" style="border-radius:5px;">
				<div class="content">
					 <div class="left">
						<div id="zstjgr_info">
						    <div class="info-img ls-img">
						    <img id="userPhoto" style="margin-top: 40px;" alt="" src="${ctxStatic}/lg-images/3.jpg">	
						    </div>
						</div>
						<div id="left_botton">
							<p id="localtime"></p>
					...
					<div class="right_" style="padding-top: 12px; position: relative;">
					...
					<div class="zs_div_">
						<p class="dbsx_"  title="待办事项" onclick="openDbsx();"><span id="syNum" style="margin-left: 5px;"></span></p>
						<p class="zsrw_ld"  title="招生任务数"><span id="rwl" style="margin-left: 5px;"></span></p>
						<p class="zswc_ld"  title="招生已完成"><span id="zsl" style="margin-left: 5px;"></span></p>
						</div> 
				</div>
			</div>
		</div>
		...
		<div id="content_botton">
			...
			<div id="content_botton_zszytj_bm">
				...
				<div id="content_bm">
				    <div style="background-color:#D31517; /* border-radius:5px; */ margin-bottom: 5px; color: #fff; text-align: center; height: 40px; line-height: 40px;">
