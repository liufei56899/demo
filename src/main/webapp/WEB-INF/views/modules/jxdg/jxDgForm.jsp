		...
		var countz=co;
		  ...
		  alertx("课时数大于总课时数！！");
		   return false;
		    ...
		    $.getJSON("${ctx}/jxdg/jxDg/findjxdgByCourseXnxq",{xnxq:xnxq,kcId:kcId},function(result) {
	        if(result.xuhao==1){
	        alertx("该学年下该课程大纲已存在！！！");
	        return false;
	        }else{
		...
		<sys:message content="${message}"/>	
		 <table id="table1" class="table table-bordered" style="width:60%;height:100%; margin-left: 20%;">	
		    <tr >
			     <td >学年学期：</td>
			     <td >
					<form:select path="xnxq" id="xnxq"  class="input-xlarge required" >
				  ...
				  <td>开学学期:</td>
			      <td>
			      <form:select path="kkxq" id="kkxq"  class="input-xlarge required" >
						<form:option value="" label="请选择" />
