...
<head>
	...
	<script type="text/javascript">
        ...
        {
        	openNewDialog("${ctx}/zsdj/zsdj/listmmDRTest/3","学校招生批量导入界面",1100,340);
        }
		
		function add()
        {
        	openNewDialog("${ctx}/zsdj/zsdj/listmm","现场报名登记",1100,480);
        }
		...
		function editJh()
		{
			...
			if(count == 1)
			{
				if(ids!=null && ids!="")
				{
				   ...
				   openNewDialog("${ctx}/zsdj/zsdj/listmm?id="+ids,"修改招生登记信息",1100,480);
				}
			}
			else if(count ==0)
			{
		...
		function deleteJh()
		{
			...
			}else
			{
				...
				confirmx('确认要删除招生登记信息吗？', "${ctx}/zsdj/zsdj/delete?ids="+ids+"&index="+1);
			}
		}
...
<body>
	<div id='dialogmmDiv' style='width:820px;'></div>
	<form:form id="searchForm" modelAttribute="zsdj" action="${ctx}/zsdj/zsdj/mmlist" method="post" class="breadcrumb form-search">
	...
	<div class="btn-div">
		...
		<input id="btnDel" class="btn btn-primary" style="background-color: red;" type="button" onclick="deleteJh()" value="删除学生信息"/>
	</div>
