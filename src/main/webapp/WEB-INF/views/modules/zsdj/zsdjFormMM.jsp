...
var xz_title = document.getElementById("xz");
	...
	<form:form id="inputForm" modelAttribute="zsdj"
		       action="${ctx}/zsdj/zsdj/savemm" method="post" class="form-horizontal">
		<form:hidden path="id" />
		...
		<div class="control-group">
		   <div class="lg-form">
			...
			<div class="controls">
				<form:select path="zsjh.id" id="jhId1" class="input-xlarge required"  
					style="width:220px;" onchange="findXueNianXueQi(this,'${ctx}','zsjj','xnxqId');findZyLxByJhId(this.value,'${ctx}','zylbDiv','');" >
		   ...
		   <div class="lg-form">
			...
			<div class="controls">
				<form:input path="xm" htmlEscape="false" maxlength="64" onclick="cleanTip()"
		...
		<div class="control-group">
			...
			<div class="lg-form">
				...
				<div class="controls">
					<form:select path="nj.id" id="njId"  class="input-xlarge " style="width:220px;">
								<form:option value="" label=""/>
		...
		<div class="control-group">
			...
			<div class="controls" id="zylbDiv">
					<select name="zylx.id" id="zylxId" onchange="lxChange(this.value)" class="input-xlarge required" style="width:220px;">
							<option value="请选择" />
					</select>
				<span class="help-inline"><font color="red">*</font> </span>
			 ...
			 <div class="controls" id="zyByLxmm" >
				<form:select path="zy.id"  class="input-xlarge required" style="width:220px;">
		...
		<div class="control-group">
			<div class="lg-form">
					...
					<div class="controls">
						<input name="csrq" type="text" id="csrq"  readonly="readonly"
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="lxdh" htmlEscape="false" maxlength="32"
					        class="input-xlarge required" onblur="validateLxdh()" style="width:208px;"/>
			    <span class="help-inline"><font color="red">*</font> </span>
			</div>
			</div>
			<div class="lg-form">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="jzNumber" htmlEscape="false" maxlength="32"
					        class="input-xlarge required" onblur="validateJzNumber()" style="width:208px;"/>
			    <span class="help-inline"><font color="red">*</font> </span>
			</div>
			</div>
		</div>
