...
function byCS(val) {
	...
	<form:form id="inputForm" modelAttribute="zsdj" action="${ctx}/zsdj/zsdj/savezs" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			<div class="lg-form">
			 ...
			 <div class="lg-form">
				...
				<div class="controls">
					<form:input path="jtzz" htmlEscape="false" maxlength="255" class="input-xlarge required" style="width:208px;"/>
					<span class="help-inline"><font color="red">*</font> </span>
				</div>
			</div>
		...
		<div class="lg-form">
		   ...
		   <div class="lg-form">
			...
			<div class="controls">
				<form:input path="lxdh" htmlEscape="false" maxlength="32" class="input-xlarge required"  style="width:208px;"
