...
<body>
	...
	<form:form id="inputForm" modelAttribute="zsdj"
		action="${ctx}/zsdj/zsdj/savedl" method="post" class="form-horizontal">
		<form:hidden path="id" />
		<form:hidden id="bcfs" path="bcfs" />
		<input type="hidden" name="ly" value="4">
		...
		<div class="control-group">
			<div class="lg-form">
				...
				<div class="controls">
					<form:select path="zsjh.id" id="jhId1"
						class="input-xlarge required" style="width:220px;"
						onchange="findXueNianXueQi(this,'${ctx}','zsjj','xnxqId');findZyLxByJhId(this.value,'${ctx}','zylbDiv','');">
						<form:option value="" label="" />
						<form:options items="${fns:findZsjhListByUserId()}"
							itemLabel="jhmc" itemValue="id" htmlEscape="false" />
					</form:select>
			...
			<div class="lg-form">
				...
				<div class="controls">
					<form:input path="xm" htmlEscape="false" maxlength="64"
		...
		<div class="control-group">
			<div class="lg-form">
				...
				<div class="controls" id="zylbDiv">
					<form:select path="zylx.id" id="zylxId"
						onchange="lxChange(this.value)" class="input-xlarge required"
						style="width:220px;">
			...
			<div class="lg-form">
				...
				<div class="controls" id="zyByLxdl">
		...
		<div class="control-group">
			<div class="lg-form">
				...
				<div class="controls">
					<label id="zsjj">${zsdj.xnxq.xnmc}</label> <input type="hidden"
						name="xnxq.id" id="xnxqId" value="${zsdj.xnxq.id}" />
				</div>
			</div>
			<div class="lg-form">
				<label class="control-label">学制：</label>
				<div class="controls">
					<label id="xzLab">${zsdj.xz}</label> <input type="hidden" name="xz"
						id="xzId" value="${zsdj.zy.xz}" />
				</div>
			</div>
		</div>
		<div class="control-group">
			<div class="lg-form">
				...
				<div class="controls">
					<form:select path="sfzjlx" id="sfzjlx"
						class="input-xlarge  required" style="width:220px;">
						<form:option value="" label="" />
			...
			<div class="lg-form">
				...
				<div class="controls">
					<form:input id="sfzjh" path="sfzjh" htmlEscape="false"
						maxlength="18" onblur="validateSfzxx('1')"
						class="input-xlarge required" style="width:208px;" />
					<span class="help-inline"><font color="red">*</font> </span>
				</div>
			</div>
		...
		<div class="control-group">
			<div class="lg-form">
				...
				<div class="controls">
					<input name="csrq" type="text" id="csrq" maxlength="20" readonly="readonly"
						class="input-medium Wdate required" onclick="WdatePicker({dateFmt:'yyyy-MM-dd',minDate:'${nowDate}',isShowClear:false});"
						value="<fmt:formatDate value="${zsdj.csrq}" pattern="yyyy-MM-dd"/>"
						style="width:208px;" /> <span class="help-inline"><font
						color="red">*</font> </span>
				</div>
			</div>
			<div class="lg-form">
			...
			<div class="lg-form">
				...
				<div class="controls">
					<form:input path="jzNumber" htmlEscape="false" maxlength="32"
						class="input-xlarge required" onblur="validateJzNumber()"
						style="width:208px;" />
					<span class="help-inline"><font color="red">*</font> </span>
				</div>
			</div>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:select path="sf" class="input-xlarge  required" id="sfid"
					style="width:100px;" onchange="byCS(this.value)">
					<form:option value="" label="请选择" />
					<form:options items="${fns:findBySF()}" itemLabel="name"
						itemValue="id" htmlEscape="false" />
				</form:select>
				<form:select path="cs" class="input-xlarge  required"
					style="width:100px;" id="cs" onchange="byQX(this.value)">
					<form:option value="" label="请选择" />
				</form:select>
				<form:select path="qx" class="input-xlarge  required"
					style="width:100px;" id="qx" onchange="byXZ(this.value)">
					<form:option value="" label="请选择" />
				</form:select>
				<form:select path="jd" class="input-xlarge  required"
					style="width:110px;" id="xz">
					<form:option value="" label="请选择" />
				</form:select>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:textarea path="remarks" htmlEscape="false" rows="4"
					maxlength="255" class="input-xxlarge" style="width:733px;" />
			</div>
		</div>
		<div class="form-actions">
			<shiro:hasPermission name="zsdj:zsdj:edit">
				<input id="btnSave" onclick="return setBcfs('save');"
