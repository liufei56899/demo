...
<head>
	...
	<script type="text/javascript">
		...
		function add()
        {
        	openNewDialog("${ctx}/zsdj/zsdj/listmmDRTest/2","网上报名登记批量导入",1100,340);
        }
		...
		{	
			...
			if(count == 1)
			{
				if(ids!=null && ids!="")
				{
				   ...
				   openNewDialog("${ctx}/zsdj/zsdj/listwspage?id="+ids,"修改招生登记信息",1100,480);
				}
			}
			else if(count ==0)
			{
		...
		function deleteJh()
		{
			...
			}else
			{
				...
				confirmx('确认要删除招生登记信息吗？', "${ctx}/zsdj/zsdj/delete?ids="+ids+"&index="+2);
			}
		}
...
<body>
<div id='dialogwsDiv' style='width:820px;'></div>
	<form:form id="searchForm" modelAttribute="zsdj" action="${ctx}/zsdj/zsdj/wslist" method="post" class="breadcrumb form-search">
	...
	<div class="btn-div">
		<input id="btnAdd" class="btn btn-primary" type="button" onclick="add()" value="导入学生信息"/>
